...
<Callout type="info">
  **Current Version:** 1.4.0 **Latest Release:** November 9, 2025
</Callout>
...
- Live Reactor / Streaming Engine: Comprehensive Twitch integration for servers including real-time channel management, automated live status roles, stream timers, custom Twitch commands, chat filters, and stream quotes.
...
- Webhooks: Fixed webhook reception issues in production by binding server to 0.0.0.0, configuring trust proxy, and simplifying webhook handler to properly process all webhook events
...
- Webhook Processing: Resolved webhook processing limitations
...
- Core Credit System: New credit-based economy for avatar generation with recurring support options
...
- Support Funding: Added funding options to GitHub FUNDING.yml for additional support channels
...
<Callout type="info">
  **Want to stay updated?** Join our [support
  server](https://discord.gg/D8tYkU75Ry) to get notified about new releases and
  updates!
</Callout>
